...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "com.sandeep.mvvmdemo.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "com.sandeep.mvvmdemo.core.navigation.RouteActivity"
